...
const MobileConnectionModal = (props) => {
  ...
  const getUniversalLink = (consume) => {
    ...
    let wasEmpty = !link;
    if (!link) {
      const hasEmbeddedRequestFeature = sdk.checkRequiredWalletFeatures((_a2 = props.wallet.features) != null ? _a2 : [], {
        embeddedRequest: {}
      });
...
const MobileUniversalModal = (props) => {
  ...
  const onSelectTelegram = () => {
    ...
    const walletSupportsEmbeddedRequest = sdk.checkRequiredWalletFeatures((_a2 = atWallet.features) != null ? _a2 : [], {
      embeddedRequest: {}
    });
  ...
  setRequestVersionHandler() {
    return __async(this, null, function* () {
      yield this.eventDispatcher.addEventListener("ton-connect-ui-request-version", () => __async(this, null, function* () {
        var _a2;
        let response = sdk.createResponseVersionEvent(
...
class TonConnectUI {
  ...
  initiateEmbeddedRequestFlow(embeddedRequest, kind, options) {
    return __async(this, null, function* () {
      const consumable = new sdk.Consumable(embeddedRequest);
      const abortController = new AbortController();
